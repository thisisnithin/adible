...
AVAILABLE_VOICES = [
    Voice(id="vBKc2FfBKJfcZNyEt1n6", description="A well-connected, young conversational male that's perfect for podcasting or casual conversations.", language="English"),
